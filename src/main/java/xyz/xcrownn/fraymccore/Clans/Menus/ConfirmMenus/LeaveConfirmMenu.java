...
public class LeaveConfirmMenu extends Menu {
    ...
    public LeaveConfirmMenu(PlayerMenuUtil playerMenuUtil) {
        super(playerMenuUtil);
    }

    @Override
    public String getMenuName() {
        return ChatColor.translateAlternateColorCodes('&', "&cLeave clan?");
    }
    ...
    public void handleMenu(InventoryClickEvent event) {
        ...
        switch (event.getSlot()) {
            ...
            case 5,6,7,8 -> ClanUtil.removePlayerFromClan(clan, player.getUniqueId());
        }
    }

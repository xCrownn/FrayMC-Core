...
public class KickPlayerMenu extends Menu {
    ...
    public KickPlayerMenu(PlayerMenuUtil playerMenuUtil) {
    ...
    public void handleMenu(InventoryClickEvent event) {
        ...
        switch (event.getSlot()) {
            ...
            case 41 -> {
                ...
                ClanUtil.removePlayerFromClan(clan, player.getUuid());
                playerMenuUtil.getOwner().sendMessage(ChatColor.translateAlternateColorCodes('&', "&cYou have successfully removed that player from the clan!"));
            }
        }
